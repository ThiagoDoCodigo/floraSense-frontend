...
import { Header, InputField, ActionButton, Typography, colors, AlertMessage } from 'react-native-th-components';
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.formContainer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Recover')} style={styles.forgotPassword}>
          <Typography variant="caption" weight="bold" color={colors.primary.main}>
            Esqueceu sua senha?
          </Typography>
        </TouchableOpacity>
      </View>
      ...
      <View style={styles.footer}>
        ...
        <TouchableOpacity onPress={() => navigation.navigate('Register')} style={styles.registerLink}>
          <Typography variant="body" align="center">
            Não possui conta? <Typography weight="bold" color={colors.primary.main}>Cadastre-se</Typography>
          </Typography>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
...
const styles = StyleSheet.create({
  ...
  forgotPassword: { alignSelf: 'flex-end', marginTop: -8, marginBottom: 24, paddingVertical: 8 },
