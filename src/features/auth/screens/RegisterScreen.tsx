...
import { Header, InputField, ActionButton, colors, AlertMessage, Button } from 'react-native-th-components';
import { useAuthViewModel } from '../viewModel/auth.viewModel';

export default function RegisterScreen() {
  const navigation = useNavigation<any>();
  const { viewModel, name, email, password, confirmPassword, error, fieldErrors } = useAuthViewModel();
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <Header title="Criar Conta" subtitle="Junte-se ao floraSense" icon={UserPlus} />
      ...
      <View style={styles.footer}>
        ...
        <Button variant="outline" label="Voltar para o Login" onPress={() => navigation.goBack()} />
      </View>
    </SafeAreaView>
  );
}
